...
class RegistrationEmail : AppCompatActivity(), TextWatcher  {
    public var binding : ActivityRegistrationEmailBinding? = null;

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityRegistrationEmailBinding.inflate(layoutInflater)
            ...
            APIob.retrofitService.SendCodeOnEmail(binding!!.editTextTextEmailAddress.text.toString())
                .enqueue(object : Callback<String> {
                    ...
                    override fun onFailure(call: Call<String>, t: Throwable) {
                        ...
                        Toast.makeText(this@RegistrationEmail, t.message, Toast.LENGTH_LONG).show()
                    ...
                    override fun onResponse(call: Call<String>, response: Response<String>) {
                        ...
                        val intent: Intent = Intent(this@RegistrationEmail, RegistrationEmail::class.java)
